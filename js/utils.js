...
function errToAr(rawMsg) {
  ...
  /* ✅ جديد — رسالة عربية جاهزة أصلاً (أُلقيت عمداً كنص عربي واضح من
     مكان آخر بالمشروع — مثل حدود عدد الوكلاء بـagents.js) تُعرض كما
     هي، بدل السقوط للعبارة العامة أدناه لمجرد أنها لا تطابق أي كلمة
     إنجليزية بالقائمة أعلاه. هذا بالضبط كان يُخفي رسائل واضحة تماماً
     خلف "حدث خطأ غير متوقع" رغم أنها مفهومة ومفيدة فعلاً. */
