...
#_tvC{position:absolute;top:0;left:0;right:0;bottom:0;width:100%;height:100%;direction:ltr;}
...
<div class="_ctw" id="_cWrap">
  ...
  function _initWidget(sym){
    ...
    if(!cont){console.error('[Chart] #_tvC missing');return;}

    /* ✅ Critical: wait for layout to settle before init */
  ...
  function _doInit(sym){
    const cont=document.getElementById('_tvC');
    if(!cont||!_visible)return;

    /* Ensure container has explicit pixel size */
