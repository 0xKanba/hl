  ...
  class HyperliquidDatafeed {
    constructor() {
      ...
      /* ✅ جديد #17 — إزاحة الساعة (clock offset) بين جهاز المستخدم
         ...
         جديد بسرعة من أول شمعة حية حقيقية تصل. */
    ...
    /* ✅ جديد #17 — الوقت المصحَّح: Date.now() الخام + إزاحة معايرة
       ...
       الرسم بلا تداول، _advanceTime) وحد getBars العلوي — أبداً لقبول
       أو رفض بيانات حقيقية (تلك تأتي من candle.t للخادم مباشرة، بلا
       أي وسيط زمني محلي). */
    _correctedNow() { return Date.now() + this._clockOffsetMs; }

    /* ✅ جديد #17 — معايرة الإزاحة من كل شمعة حقيقية (غير مصطنعة) تصل
       فعلاً من الخادم عبر _ingestCandle. سبب الإصلاح مفصَّل برأس الملف
       ...
       بدل 14:00" حين تكون ساعة الجهاز متقدّمة.
    ...
    */
    ...
    /* ══════════════════════════════════════════════════════════════
       ...
       ذاتياً أي انحراف كان سيتسرّب لاحقاً عبر _advanceTime.
       ══════════════════════════════════════════════════════════════ */
